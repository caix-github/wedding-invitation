 ...
 * @Date: 2026-09-17 21:21:23
 * @LastEditors: caix cai1058@qq.com
 * @LastEditTime: 2026-09-23 06:38:32
...
理论上大家只要像做填空题一样把自己的婚礼信息填进去就可以了，需要修改两个文件，分别是 [app.js](./miniprogram/app.js) 和 [index.js](./miniprogram/pages/index/index.js)
...
- music 背景音乐
- location 酒店信息（可以去高德地图或腾讯地图网页版上把经纬度爬下来）
- imgs 图片信息

至于图片怎么裁剪以及怎么上传到CDN几个办法：
...
- desc 公告栏描述
- phone 其余人员联系方式
- location 定位信息（可以去高德地图或腾讯地图网页版上把经纬度爬下来）
